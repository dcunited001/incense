...
# add to gemfile if not installed with heroku-toolbelt
...
gem 'turbolinks', '~> 1.1'  # Turbolinks makes following links in your web application faster. Read more: https://github.com/rails/turbolinks
